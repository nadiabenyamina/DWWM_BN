...
<table class="table text-center">
    ...
    <tr>
        ...
        <td class="align-middle"><a href="<?= URL ?>livres/m/<?= $livres[$i]->getId() ?>" class="btn btn-outline-warning">Modifier</a></td>
...
<a href="<?= URL ?>livres/a" class="btn btn-outline-success d-block">Ajouter</a>
